...
import (
	...
	"github.com/keycloak/keycloak-realm-operator/version"
	...
	keycloakv1alpha1 "github.com/keycloak/keycloak-realm-operator/pkg/apis/keycloak/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &keycloakv1alpha1.ExternalKeycloak{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	if err := common.WatchSecondaryResource(c, ControllerName, common.SecretKind, &corev1.Secret{}, &kc.ExternalKeycloak{}); err != nil {
		return err
	}
...
func (r *ReconcileKeycloak) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &keycloakv1alpha1.ExternalKeycloak{}
...
func (r *ReconcileKeycloak) ManageError(instance *v1alpha1.ExternalKeycloak, issue error) (reconcile.Result, error) {
...
func (r *ReconcileKeycloak) ManageSuccess(instance *v1alpha1.ExternalKeycloak, currentState *common.ClusterState) (reconcile.Result, error) {
	...
	instance.Status.Message = ""
	instance.Status.Phase = v1alpha1.PhaseReconciling
	instance.Status.ExternalURL = instance.Spec.URL
...
func (r *ReconcileKeycloak) setVersion(instance *v1alpha1.ExternalKeycloak) {
