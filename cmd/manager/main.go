...
import (
	...
	"github.com/keycloak/keycloak-realm-operator/pkg/k8sutil"
	...
	"github.com/keycloak/keycloak-realm-operator/pkg/apis"
	"github.com/keycloak/keycloak-realm-operator/pkg/controller"
...
func main() {
	...
	err = leader.Become(ctx, "keycloak-realm-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
...
func addMetrics(ctx context.Context, cfg *rest.Config) {
	...
	if err != nil {
		...
		if err == metrics.ErrServiceMonitorNotPresent { //nolint
